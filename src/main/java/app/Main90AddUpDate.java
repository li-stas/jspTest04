...
public class Main90AddUpDate {
    public static void main(String[] args) throws SQLException {
        ...
        Emp emp9000 = new Emp(9000, "DAVID", "SALESMAN",7698,
                LocalDateTime.parse("1991-09-29 00:00", DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm")),
                1550,1700);
        emp9000.setDept(dept);
        dept.addEmp(emp9000);

        Emp emp9001 = new Emp(9001, "OLGA", "SALESMAN",7698,
                LocalDateTime.parse("2013-09-04 00:00",DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm")),
                1999,999);
